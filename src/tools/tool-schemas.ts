/**
 * Tool schemas for AI function calling API used by Ani Code is Coding.
...
export const INITIALIZE_CONTEXT_SCHEMA: ToolSchema = {
  type: 'function',
  function: {
    name: 'initialize_context',
    description: 'Initialize context engineering for a project by creating a /context folder with essential documentation templates. Use this to set up proper AI-friendly documentation structure.',
    parameters: {
      type: 'object',
      properties: {
        project_path: {
          type: 'string',
          description: 'Path to the project root directory. Defaults to current directory if not specified.'
        }
      },
      required: []
    }
...
export const ANALYZE_CONTEXT_SCHEMA: ToolSchema = {
  type: 'function',
  function: {
    name: 'analyze_context',
    description: 'Analyze the project structure and update context documentation with discovered insights about languages, frameworks, and architecture.',
    parameters: {
      type: 'object',
      properties: {
        project_path: {
...
export const CHECK_CONTEXT_HEALTH_SCHEMA: ToolSchema = {
  type: 'function',
  function: {
    name: 'check_context_health',
    description: 'Check the health and freshness of context documentation. Reports missing files, outdated content, and provides recommendations for improvements.',
    parameters: {
      type: 'object',
      properties: {
        project_path: {
...
export const UPDATE_AGENT_MEMORY_SCHEMA: ToolSchema = {
  type: 'function',
  function: {
    name: 'update_agent_memory',
    description: 'Record learnings, patterns, issues, or insights about the project into AGENT_MEMORY.md. Use this to maintain persistent knowledge across sessions.',
    parameters: {
      type: 'object',
      properties: {
        learning: {
          type: 'string',
          description: 'The learning, insight, or discovery to record. Be specific and include file paths or code references when relevant.'
        },
        category: {
          type: 'string',
          enum: ['pattern', 'issue', 'performance', 'integration', 'general'],
          description: 'Category of the learning: pattern (code patterns), issue (bugs/problems), performance (optimizations), integration (external services), general (other learnings)'
        },
        project_path: {
          type: 'string',
          description: 'Path to the project root directory. Defaults to current directory if not specified.'
...
export const ALL_TOOL_SCHEMAS = [
  ...
  INITIALIZE_CONTEXT_SCHEMA,
  ANALYZE_CONTEXT_SCHEMA,
  CHECK_CONTEXT_HEALTH_SCHEMA,
  UPDATE_AGENT_MEMORY_SCHEMA
];
